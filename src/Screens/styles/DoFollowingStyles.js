...
const styles = StyleSheet.create({
    ...
    profileView: { flex: 1, flexDirection: "row", paddingVertical: hp(2), marginHorizontal: hp(2), borderBottomWidth: hp(0.2) },
    ImageView: { flexDirection: "row", flex: 1 },
    profileImage: { height: hp(9.2), width: hp(9.2), borderRadius: hp(100) },
    TXT: { fontSize: hp(2.6), color: "#FE2C55", fontWeight: "bold" },
    TXT1: { fontFamily: Fonts.LatoBlack, fontSize: hp(3) },
    TXT2: { fontFamily: Fonts.LatoBold, color: "#7C7A7A", fontSize: hp(2), marginTop: hp(1) },
