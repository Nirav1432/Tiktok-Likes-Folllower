...
const styles = StyleSheet.create({
    ...
    BTNSTYLE: { height: hp(6), width: wp(40), borderRadius: hp(100), backgroundColor: "#006CFF", justifyContent: "center", alignItems: "center" },
    TXT3: { fontFamily: Fonts.LatoBlack, color: "white", fontSize: hp(2.5) },
    BTNSTYLE1: { height: hp(6), flexDirection: "row", width: wp(40), borderRadius: hp(100), backgroundColor: "#FE2C55", justifyContent: "center", alignItems: "center" },
