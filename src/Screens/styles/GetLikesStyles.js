...
const styles = StyleSheet.create({
    ...
    BTNSTYLE: { height: hp(8), width: wp(42), borderRadius: hp(100), backgroundColor: "#006CFF", justifyContent: "center", alignItems: "center" },
    TXT3: { fontFamily: Fonts.LatoBlack, color: "white", fontSize: hp(2.5) },
    BTNSTYLE1: { height: hp(8), flexDirection: "row", width: wp(42), borderRadius: hp(100), backgroundColor: "#FE2C55", justifyContent: "center", alignItems: "center" },
