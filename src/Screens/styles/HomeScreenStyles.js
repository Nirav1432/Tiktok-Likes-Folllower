...
const styles = StyleSheet.create({
    ...
    VIW8: { justifyContent: "center", alignItems: "flex-end", backgroundColor: "blue", position: "absolute", width: "20%", alignSelf: "flex-end" },
    ...
    IMG1: { height: hp(18), width: hp(18), top: hp(-9), position: "absolute", alignSelf: "center", borderRadius: hp(100), borderWidth: hp(0.3), borderColor: "#FFB9C7" },
