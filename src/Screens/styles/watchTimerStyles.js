...
const styles = StyleSheet.create({
    ...
    TXT1: { fontFamily: Fonts.LatoBlack, color: "#FE2C55", fontSize: hp(4), alignSelf: "center", marginTop: hp(6) },
    TXT2: { fontFamily: Fonts.LatoBlack, fontSize: hp(3), lineHeight: hp(4), textAlign: "center", alignSelf: "center", marginTop: hp(2) },
    ...
    timerTExt: { fontFamily: Fonts.LatoBlack, color: "white", fontSize: hp(3) },
    ...
    Timer2: { height: hp(9), flexDirection: "row", width: wp(60), backgroundColor: "#FE2C55", borderRadius: hp(100), elevation: 10, alignSelf: "center", marginTop: hp(8), alignItems: "center", padding: 0 },
