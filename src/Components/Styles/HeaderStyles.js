...
const styles = StyleSheet.create({
    ...
    VIW9: { height: hp(7), backgroundColor: "#FE7E97", width: "28%", position: "absolute", alignSelf: "flex-end", borderTopLeftRadius: hp(100), borderBottomLeftRadius: hp(100), flexDirection: "row", padding: hp(1) },
